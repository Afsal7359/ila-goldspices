...
const SCHEMA: Section[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "home_products_eyebrow",    label: "Products Section Eyebrow", type: "text" },
      { key: "home_products_headline",   label: "Products Section Headline", type: "textarea" },
      { key: "home_wholesale_headline",  label: "Wholesale Section Headline", type: "textarea" },
      { key: "home_wholesale_description", label: "Wholesale Section Description", type: "textarea" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "about_story_image",      label: "Story Section Image",   type: "image" },
      ...
      { key: "about_strip_image_1",    label: "Image Strip — Image 1", type: "image" },
      { key: "about_strip_image_2",    label: "Image Strip — Image 2", type: "image" },
      { key: "about_strip_image_3",    label: "Image Strip — Image 3", type: "image" },
      { key: "about_strip_image_4",    label: "Image Strip — Image 4", type: "image" },
